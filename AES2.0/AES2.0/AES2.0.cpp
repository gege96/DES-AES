...
void encryptFile(string inputfile, string outfile, string k){
	//string keyStr = "abcdefghijklmnop";
	byte key[16];
	charToByte(key, k.c_str());
	// 密钥扩展  
	word w[4 * (Nr + 1)];
	KeyExpansion(key, w);
...
void dencryptFile(string inputfile, string outfile, string k){
...
int main()
{
	...
	encryptFile("D://flower.jpg", "D://cipher1.txt", "abcdefghijklmnop");
	dencryptFile("D://cipher1.txt", "D://flower2.jpg", "abcdefghijklmnop");
	//system("pause");
}
